...
// import { ItemTable, ItemTableTableId } from "../src/codegen/Tables.sol";
...
//     uint32 counter = ItemTable.get(world, key);
//     assertEq(counter, 1);

//     // Expect the counter to be 2 after calling increment.
//     world.increment();
//     counter = ItemTable.get(world, key);
//     assertEq(counter, 2);
//   }
...
//     bytes32 key = SingletonKey;
//     uint32 counter = ItemTable.get(world, key);
//     bytes32[] memory keysWithValue = getKeysWithValue(world, ItemTableTableId, ItemTable.encode(counter));
